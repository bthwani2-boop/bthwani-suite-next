...
export function CpRetryButton({ onClick, children }: { readonly onClick: () => void; readonly children: ReactNode }) { const { styles } = useCpTokens(); return <Button onClick={onClick} style={styles.retryButton}>{children}</Button>; }
