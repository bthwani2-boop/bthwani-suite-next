...
- اقتراح أو اعتماد أو تطبيق متغيرات المنصة والـfeature flags يبقى ضمن صلاحيات Platform Control ودورة Change Sets في ؛ لا تنقل  ملكيتها إلى الواجهة.
...
- Change Sets وprogressive rollout: مملوكة لـ و، عدا قراءتها الحالية ضمن Platform Control.
