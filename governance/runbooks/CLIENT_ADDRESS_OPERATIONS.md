...
The journey may be `READY_FOR_REVIEW` after `journeys//all-slices` succeeds on the exact implementation commit. `CLOSED_WITH_EVIDENCE` additionally requires independent Product, QA, Security, Privacy, Accessibility and Release approvals plus device evidence.
