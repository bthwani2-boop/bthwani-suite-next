...
- Database rollback may remove  indexes and constraints only after confirming no dependent query or cleanup worker.
- Re-run `.github/workflows/fullstack-slices.yml` after rollback or forward repair.

## FS-15 decision

`CLOSED_WITH_IMPLEMENTATION_EVIDENCE`: support diagnosis, metrics, incident response, retention and rollback procedures are defined and checked by the  gate.
