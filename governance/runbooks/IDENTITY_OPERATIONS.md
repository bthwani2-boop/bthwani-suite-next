...
6. PostgreSQL constraint violations on  tables.
...
- Application rollback: deploy the last commit whose `journeys//runtime-proof` and targeted verification statuses both succeeded.
...
- `.github/workflows/identity-runtime.yml`
- `.github/workflows/010-sambassam-verify.yml`
- `core/identity/tests/fullstack-slices.test.mjs`
