...
- captain inbox or operator list failures by operator context;
...
3. For an active pre-pickup assignment, choose either cancellation or an eligible replacement captain in the same operator context and service area.
...
Escalate to security for cross-operator-context or actor-ownership evidence, to Workforce for accreditation/vehicle/employment projection errors, to platform operations for service-area truth, and to WLT only for financial projections. Assignment truth remains in DSH.
