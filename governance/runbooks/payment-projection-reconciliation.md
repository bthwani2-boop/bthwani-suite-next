# — WLT Payment Projection Reconciliation
...
4. enters the transactional outbox and then the canonical operational outbox bridge.
...
3. Inspect due/retry/processing rows by operator context and order ID.
