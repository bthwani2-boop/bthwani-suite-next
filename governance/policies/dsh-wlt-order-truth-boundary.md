...
- The immutable order identity, `orderNumber`, operator context/client/store linkage and `correlationId`.
...
- Creation idempotency, event outbox, readback and operator context/actor isolation.
