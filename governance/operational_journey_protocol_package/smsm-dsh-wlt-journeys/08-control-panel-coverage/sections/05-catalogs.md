# اعتماد الكتالوجات — عقد الإغلاق النهائي

```yaml
section_id: catalogs
canonical_route: /dsh/catalogs
routes: [/dsh/catalogs, /dsh/catalogs/governance]
...
Taxonomy، Master Products، variants/barcodes/media، proposals، review/conflict/merge، assortment/inventory/price/publication. يجب جرد كل Tab وDrawer وDetail وWizard وTable وCard وForm وDialog وربطه بالرحلات والـoperationIds، مع N/A مبررة للعناصر غير المنطبقة.
...
إنشاء وتعديل ونقل ودمج وإهمال، submit/claim/request-info/approve/reject، publish، upload/reorder، bulk preview. كل تحكم يملك accessibility name وpermission visibility منفصلة عن business enablement وloading محليًا ومنع double-submit وstale-conflict handling وunknown-result lookup وsuccess readback. لا زر أو Icon شكلي بلا API binding أو أثر.
...
Canonical catalog IDs وlineage وversions؛ Store overrides محددة؛ media refs فقط؛ لا عقد أو منتج محلي موازٍ. يجب توثيق owner لكل حقل وحالة وقرار، operationId/handler/repository/table/event/job/cache consumer، ومنع أي type/status/policy/formatter/fallback محلي يكرر السلطة.
...
`section_id=catalogs; registered_routes=PASS; unmapped_pages_tabs_controls_states=0; permission_backend_mismatches=0; parallel_truths=0; automated_tests=PASS; manual_acceptance=PASS; same_sha_evidence=PASS`.
