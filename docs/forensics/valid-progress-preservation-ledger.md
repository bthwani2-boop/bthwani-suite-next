...
| `fix/master-pr23-pr27-total-closure` | UI helper scripts: `tools/scripts/fix-missing-color-roles.mjs`, `fix-raw-hex.mjs`, `fix-use-client.mjs`, `run-slice-gate.ps1` | `KEEP_NOW` | Wide UI refactoring and slice validation scripts | Same paths | Checked out and staged |
