...
Current Product Truth, DSH contracts, Identity/Workforce ownership and WLT boundary rules override stale operational details.
...
7. For publication issues, verify all current store/partner/catalog/readiness/marketing/serviceability gates required by Product Truth.
