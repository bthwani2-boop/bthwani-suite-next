...
Canonical Product Truth: `governance/product/contracts/order-creation.product-truth.json` (DSH order projection) and `governance/product/contracts/wlt-money-movement-settlement.product-truth.json` (WLT financial truth)
