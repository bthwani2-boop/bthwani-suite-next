...
const rules = [
  ...
  ["services/dsh/backend/internal/http/client_addresses.go", [[/r\.URL\.Query\(\)\.Get\(["']clientId["']\)/g, "ENUMERABLE_ADDRESS_OWNER_FORBIDDEN"]], ['requireActor(w, r, "client")', 'r.Header.Get("Idempotency-Key")', 'r.Header.Get("If-Match-Version")', "clientaddress.Create", "clientaddress.Update", "clientaddress.Delete", "clientaddress.SetDefault"]],
