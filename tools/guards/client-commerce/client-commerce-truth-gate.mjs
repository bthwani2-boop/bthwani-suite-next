...
const rules = [
  ...
  ], ['requireActor(w, r, "client")', "addressMutationContext", "addressExpectedVersion", "clientaddress.UpdateIdempotent", "clientaddress.DeleteIdempotent", "clientaddress.SetDefaultIdempotent", "clientaddress.IsDuplicateError", "IDEMPOTENCY_CONFLICT", "ADDRESS_ALREADY_EXISTS", "ValidateServiceArea"]],
  ...
  [".github/workflows/jrn-005-all-slices.yml", [], ["postgres:16-alpine", "go test ./internal/clientaddress ./internal/http", "tsconfig.jrn-005-app-client.json", "dsh-907_jrn_005_address_mutation_receipts.sql", "journeys/jrn-005/all-slices"]],
