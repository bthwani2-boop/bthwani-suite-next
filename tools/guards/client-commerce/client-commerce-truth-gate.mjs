...
const rules = [
  ...
  ], ['requireActor(w, r, "client")', "addressMutationContext", "addressExpectedVersion", "clientaddress.UpdateIdempotent", "clientaddress.DeleteIdempotent", "clientaddress.SetDefaultIdempotent", "observeClientAddressOperation", "clientaddress.RecordOperation", "clientaddress.IsDuplicateError", "IDEMPOTENCY_CONFLICT", "ADDRESS_ALREADY_EXISTS", "ValidateServiceArea"]],
  ...
  ["services/dsh/backend/internal/http/unified_handler_aliases.go", [], ["AnalyticsPermissionRead", "clientaddress.DiagnoseIntegrity", "clientaddress.TelemetrySnapshot", '"clientAddressBook"']],
  ...
  [".github/workflows/jrn-005-all-slices.yml", [], ["postgres:16-alpine", "jrn-005-runtime-observability.test.mjs", "go test ./internal/clientaddress ./internal/http", "tsconfig.jrn-005-app-client.json", "dsh-907_jrn_005_address_mutation_receipts.sql", "journeys/jrn-005/all-slices"]],
