...
const rules = [
  ...
  ["services/dsh/backend/internal/clientaddress/ownership_isolation_db_test.go", [], ["TestClientAddressMutationOwnershipIsolation", "cross-client update", "cross-client delete", "cross-client set-default", "receiptCount != 0", "owner address"]],
