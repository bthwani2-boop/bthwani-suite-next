...
const rules = [
  ...
  ["services/dsh/contracts/jrn-005-all-slices-registry.json", [], ["schemaVersion\": 2", "FS-01", "FS-18", "IMPLEMENTED_VERIFIED", "CODE_CLOSED_PENDING_INDEPENDENT_EVIDENCE", '"codeClosureDecision": "CLOSED"', '"openCodeGaps": []']],
  ...
  ["services/dsh/tests/jrn-005-runtime-observability.test.mjs", [], ["aggregate telemetry", "database invariant diagnostics", "DiagnoseIntegrity", "TelemetrySnapshot"]],
  ["services/dsh/tests/jrn-005-replay-compatibility.test.mjs", [], ["FindUpdateReplay", "service-area validation must run after replay lookup", "client-address-book", "handlePlatformKpis"]],
  ["services/dsh/tests/jrn-005-address-experience.test.mjs", [], ["shared brain", "client-address-label", "accessibilityLiveRegion", "validateClientAddressDraft"]],
  [".github/workflows/jrn-005-all-slices.yml", [], ["postgres:16-alpine", "jrn-005-address-experience.test.mjs", "go test ./internal/clientaddress ./internal/http", "DSH_TEST_DATABASE_URL", "dsh-076_service_area_geofences.sql", "dsh-906_jrn_006_client_address_geofence_binding.sql", "dsh-908_jrn_005_mutation_receipt_retention.sql", "Test(IdempotentAddressMutationsAreExactlyOnceAndClientScoped|ClientAddressMutationOwnershipIsolation)", "journeys/jrn-005/all-slices"]],
  ["governance/evidence/JRN-005_CLIENT_ADDRESS_BOOK_CLOSURE.json", [], ["codeClosure", "functionalSlices", "sameCommitVerification", "approvalMatrix", "formalClosureRule"]],
