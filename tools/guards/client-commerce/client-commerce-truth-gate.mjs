...
const rules = [
  ...
  ["services/dsh/contracts/jrn-005-consistency-registry.json", [], ["JRN-005", "uq_dsh_client_addresses_active_fingerprint", "prevent-active-logical-duplicates", "ADDRESS_ALREADY_EXISTS", "same-commit database migration execution"]],
