...
const rules = [
  ...
  ["services/dsh/frontend/shared/client-address/use-client-address-controller.ts", [], ["ADDRESS_ALREADY_EXISTS", "هذا العنوان محفوظ بالفعل", "ADDRESS_CONFLICT", "await load()"]],
  ...
  ["services/dsh/backend/internal/http/client_addresses.go", [[/r\.URL\.Query\(\)\.Get\(["']clientId["']\)/g, "ENUMERABLE_ADDRESS_OWNER_FORBIDDEN"]], ['requireActor(w, r, "client")', 'r.Header.Get("Idempotency-Key")', 'r.Header.Get("If-Match-Version")', "clientaddress.Create", "clientaddress.Update", "clientaddress.Delete", "clientaddress.SetDefault", "clientaddress.IsDuplicateError", "ADDRESS_ALREADY_EXISTS", "ValidateServiceArea"]],
  ...
  ["services/dsh/contracts/dsh.client-address.openapi.yaml", [], ["listDshClientAddresses", "createDshClientAddress", "updateDshClientAddress", "deleteDshClientAddress", "setDshClientDefaultAddress", "x-bthwani-client-binding: MANUAL_TYPED_ADAPTER", "duplicate-address"]],
  ...
  [".github/workflows/jrn-005-all-slices.yml", [], ["postgres:16-alpine", "jrn-005-all-slices.test.mjs", "dsh-901_client_address_logical_deduplication.sql", "journeys/jrn-005/all-slices"]],
