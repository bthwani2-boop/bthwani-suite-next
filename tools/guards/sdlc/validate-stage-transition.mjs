...
for (const marker of [
  ...
  "OperatorContext_or_isolation_change_requires_isolation_security_approval",
  "residual_risk_requires_risk_acceptance_authority",
  "partner_activation_requires_explicit_product_security_finance_isolation_release_and_production_evidence",
