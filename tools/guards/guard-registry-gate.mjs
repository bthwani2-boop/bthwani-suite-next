...
if (fs.existsSync(path.join(repoRoot, retiredRegistrationRoot))) {
  violations.push({ file: retiredRegistrationRoot, line: 0, message: "PARALLEL_GUARD_REGISTRATION_LAYER_FORBIDDEN" });
}
...
for (const requiredId of [
  "governance-schema", "agent-governance", "authority-separation", "guard-registry", "direct-work-branch-execution",
  "sdlc", "workflow-lint", "workflow-security", "actions-pin", "a11y-runtime",
]) {
