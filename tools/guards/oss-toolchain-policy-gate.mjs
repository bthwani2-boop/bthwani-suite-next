 ...
 * Strictly forbids paid platform/proprietary additions.
 *
  ...
  for (const entry of catalog.entries || []) {
    if (entry.oss_free !== true) {
      violations.push({
        ...
        line: 0,
        message: `PROPRIETARY_TOOL_FORBIDDEN: Tool '${entry.id}' is not marked as open source/free. Paid/platform tools are prohibited.`,
      });
    }
  }
}
