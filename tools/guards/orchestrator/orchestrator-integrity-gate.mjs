...
const readme=await text('plans/diagnose-implementing/README.md');if(!readme.includes('NAVIGATION_ONLY'))fail('README must remain navigation-only, not a competing rule owner');
