...
def remove_section(text: str, start_marker: str, end_marker: str, label: str) -> str:
...
for path_key in (
    ...
    method = catalog_paths.find("  put:\n", start, None if next_path < 0 else next_path)
    if method >= 0:
