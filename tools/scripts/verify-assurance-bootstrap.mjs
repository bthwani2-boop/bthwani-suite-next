...
const required = [
  ...
  [".github/workflows/repository-baseline.yml", "BThwani / Repository Health", "Repository Health must have its own status context"],
  [".github/workflows/repository-baseline.yml", "BASELINE_OPEN", "Open baseline debt must remain explicit"],
  [".github/workflows/repository-baseline.yml", "uses: ./.github/workflows/codeql.yml", "Repository Health must include a full CodeQL baseline"],
  [".github/workflows/repository-baseline.yml", "uses: ./.github/workflows/sonarqube.yml", "Repository Health must include a full Sonar baseline"],
