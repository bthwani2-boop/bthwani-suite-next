...
const specs = [
  ...
  { input: 'core/identity/contracts/generated/identity.bundle.openapi.yaml', output: 'contracts/identity.bundled.json', name: 'Core - Identity API' },
  { input: 'core/platform-control/contracts/platform-control.openapi.yaml', output: 'contracts/platform-control.bundled.json', name: 'Core - Platform Control API' },
