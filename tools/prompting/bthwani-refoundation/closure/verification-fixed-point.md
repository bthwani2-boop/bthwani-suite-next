...
Target-package aggregate proof must additionally show, when materially applicable:

```text
MATERIAL_SURFACE_INTERACTION_BINDING=PASS
REQUIRED_OPERATOR_CORRELATION=PASS_WHEN_APPLICABLE
VERSION_SKEW_COMPATIBILITY=PASS_WHEN_APPLICABLE
MATERIAL_OPERATION_FAILURE_CONTRACT=PASS
