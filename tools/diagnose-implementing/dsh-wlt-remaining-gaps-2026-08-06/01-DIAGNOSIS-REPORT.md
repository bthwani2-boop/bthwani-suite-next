...
5. Generate all DSH readiness projections from one same-commit evidence ledger.
6. Close WLT financial evidence while production mutation remains disabled.
7. Make DSH/WLT runtime evidence dependency-complete and unambiguous.
8. Close FOUNDATION-00 and journeys J001 through J107 sequentially.
