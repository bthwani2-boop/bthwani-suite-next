# PHASE-00 — السلطة والرأس

## النتيجة

تثبيت remote SHA وقراءة السلطات والأمر الحاكم والقالب والمدقق.
...
- لا توجد كتابة منتج؛ هذه مرحلة تثبيت أو نقل أدلة.

## بوابة الخروج

الحزمة strict-valid على SHA مثبت ولا تعديل خارجها.
