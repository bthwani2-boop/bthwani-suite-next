# U003 — client-cart-serviceability-checkout-order-create

## Scope and owner

**Execution concern:** cart, serviceability, checkout intent and exactly-once order creation

**Objective:** Close the customer purchase path from governed cart through canonical address/serviceability/payment decision and checkout intent to exactly-once DSH order creation with immutable commercial/address snapshots.

**Canonical owner:** DSH owns cart/checkout/order operational truth and serviceability; WLT owns financial truth referenced by checkout/order.
