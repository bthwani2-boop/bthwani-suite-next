...
type paymentSessionInputValidator func(http.ResponseWriter, *CreatePaymentSessionInput) bool

func handleCreatePaymentSession(db *sql.DB, validate paymentSessionInputValidator) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		if validate != nil && !validate(w, &input) {
			return
		}
...
func validateCheckoutPaymentSessionInput(w http.ResponseWriter, input *CreatePaymentSessionInput) bool {
...
func validateTrustedPaymentSessionInput(w http.ResponseWriter, input *CreatePaymentSessionInput) bool {
