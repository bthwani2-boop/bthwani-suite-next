...
func TestSettlementRejectsCancellation(t *testing.T) {
...
func TestSettlementRejectsMissingPricingOrCompletionEvidence(t *testing.T) {
...
func TestSettlementRejectsDuplicateOrders(t *testing.T) {
	input := validJRN036SettlementInput()
...
func TestSettlementFeeRoundingRemainsDeterministic(t *testing.T) {
