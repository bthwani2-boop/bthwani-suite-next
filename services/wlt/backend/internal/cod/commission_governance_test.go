...
func TestCalculateFixedCommission(t *testing.T) {
...
func TestCalculateBasisPointsWithBounds(t *testing.T) {
	maximum := int64(8000)
	policy := GovernedCommissionPolicy{
...
func TestFieldVisitDerivesEvidenceButNeverAmount(t *testing.T) {
...
func TestNonFieldCommissionRequiresEvidence(t *testing.T) {
...
func TestRejectsCancelledOrUnverifiedEvidence(t *testing.T) {
