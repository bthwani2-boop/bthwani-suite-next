...
-- caller-reconstructed canonical bytes prove provider origin.
...
COMMENT ON COLUMN wlt_external_provider_statements.provenance_type IS
  'Explicit origin class. operator_attested is human-import authority; provider_signed/provider_api_verified require an independent evidence digest.';
COMMENT ON COLUMN wlt_external_provider_statements.provenance_evidence_sha256 IS
  'Immutable digest of the independent signature/API/raw evidence when provenance_type is not operator_attested.';
