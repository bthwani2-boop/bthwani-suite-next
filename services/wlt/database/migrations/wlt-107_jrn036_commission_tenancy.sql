...
CREATE UNIQUE INDEX wlt_jrn036_commission_policy_active_tenant_uidx
  ON wlt_jrn036_commission_policy_versions
    (tenant_id, commission_type, source_type, beneficiary_actor_type)
  WHERE status = 'active';
CREATE INDEX wlt_jrn036_commission_policy_tenant_history_idx
  ON wlt_jrn036_commission_policy_versions (tenant_id, policy_id, version DESC);
...
CREATE UNIQUE INDEX wlt_jrn036_commission_adjustments_tenant_idempotency_uq
  ON wlt_jrn036_commission_adjustments (tenant_id, idempotency_key);
CREATE INDEX wlt_jrn036_commission_adjustments_tenant_request_hash_idx
  ON wlt_jrn036_commission_adjustments (tenant_id, request_hash);
CREATE INDEX wlt_jrn036_commission_adjustments_tenant_commission_created_idx
  ON wlt_jrn036_commission_adjustments (tenant_id, commission_id, created_at, id);

COMMENT ON COLUMN wlt_jrn036_commission_policy_versions.tenant_id IS
  'Tenant owning this versioned commission calculation policy.';
COMMENT ON COLUMN wlt_jrn036_commission_adjustments.tenant_id IS
