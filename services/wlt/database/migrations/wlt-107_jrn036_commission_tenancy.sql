...
ALTER TABLE wlt_jrn036_commission_policy_versions
...
UPDATE wlt_jrn036_commission_policy_versions policy
...
ALTER TABLE wlt_jrn036_commission_policy_versions
  ...
  DROP CONSTRAINT IF EXISTS wlt_jrn036_commission_policy_versions_pkey;
ALTER TABLE wlt_jrn036_commission_policy_versions
  ADD CONSTRAINT wlt_jrn036_commission_policy_versions_pkey
  PRIMARY KEY (operator_context_id, policy_id, version);
DROP INDEX IF EXISTS wlt_jrn036_commission_policy_active_uidx;
CREATE UNIQUE INDEX wlt_jrn036_commission_policy_active_OperatorContext_uidx
  ON wlt_jrn036_commission_policy_versions
    (operator_context_id, commission_type, source_type, beneficiary_actor_type)
  WHERE status = 'active';
CREATE INDEX wlt_jrn036_commission_policy_OperatorContext_history_idx
  ON wlt_jrn036_commission_policy_versions (operator_context_id, policy_id, version DESC);
...
ALTER TABLE wlt_jrn036_commission_adjustments
  ADD COLUMN IF NOT EXISTS operator_context_id text;
UPDATE wlt_jrn036_commission_adjustments adjustment
...
UPDATE wlt_jrn036_commission_adjustments
SET operator_context_id = 'legacy-unscoped'
WHERE operator_context_id IS NULL OR btrim(operator_context_id) = '';
ALTER TABLE wlt_jrn036_commission_adjustments
  ALTER COLUMN operator_context_id SET NOT NULL;
ALTER TABLE wlt_jrn036_commission_adjustments
  DROP CONSTRAINT IF EXISTS wlt_jrn036_commission_adjustments_idempotency_key_key;
DROP INDEX IF EXISTS wlt_jrn036_commission_adjustments_request_hash_idx;
DROP INDEX IF EXISTS wlt_jrn036_commission_adjustments_commission_created_idx;
CREATE UNIQUE INDEX wlt_jrn036_commission_adjustments_operator_context_idempotency_uq
  ON wlt_jrn036_commission_adjustments (operator_context_id, idempotency_key);
CREATE INDEX wlt_jrn036_commission_adjustments_OperatorContext_request_hash_idx
  ON wlt_jrn036_commission_adjustments (operator_context_id, request_hash);
CREATE INDEX wlt_jrn036_commission_adjustments_OperatorContext_commission_created_idx
  ON wlt_jrn036_commission_adjustments (operator_context_id, commission_id, created_at, id);

COMMENT ON COLUMN wlt_jrn036_commission_policy_versions.operator_context_id IS
  'OperatorContext owning this versioned commission calculation policy.';
COMMENT ON COLUMN wlt_jrn036_commission_adjustments.operator_context_id IS
