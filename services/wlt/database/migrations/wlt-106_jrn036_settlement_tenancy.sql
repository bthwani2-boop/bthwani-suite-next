...
CREATE INDEX wlt_jrn036_settlement_policy_tenant_current_idx
  ON wlt_jrn036_settlement_policy_versions (tenant_id, partner_id, version DESC);
...
CREATE UNIQUE INDEX wlt_jrn036_settlement_completion_event_tenant_uidx
  ON wlt_jrn036_settlement_source_evidence (tenant_id, completion_event_id);
CREATE INDEX wlt_jrn036_settlement_evidence_tenant_settlement_idx
  ON wlt_jrn036_settlement_source_evidence (tenant_id, settlement_id, order_id);
...
CREATE UNIQUE INDEX wlt_jrn036_settlement_request_tenant_hash_uidx
  ON wlt_jrn036_settlement_requests (tenant_id, request_hash);
CREATE INDEX wlt_jrn036_settlement_request_tenant_partner_idx
  ON wlt_jrn036_settlement_requests (tenant_id, partner_id, created_at DESC);
...
COMMENT ON COLUMN wlt_jrn036_settlement_requests.tenant_id IS
  'Tenant-local idempotency and request evidence identity.';
COMMENT ON COLUMN wlt_jrn036_settlement_source_evidence.tenant_id IS
