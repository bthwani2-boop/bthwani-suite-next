-- WLT-098 / : typed payout destinations, destination-bound requests,
...
-- handlers that predate . It cannot release or move funds itself.
...
COMMENT ON TABLE wlt_payout_audit_events IS
  'Append-only  audit for destination, payout and reconciliation lifecycle changes.';
