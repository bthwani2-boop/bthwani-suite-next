-- WLT-093: atomic idempotency receipts for settlements-commissions policy and lifecycle
...
CREATE TABLE IF NOT EXISTS wlt_mutation_receipts (
...
CREATE INDEX IF NOT EXISTS wlt_mutation_receipts_aggregate_idx
  ON wlt_mutation_receipts(mutation_type, aggregate_id, created_at DESC);

CREATE INDEX IF NOT EXISTS wlt_mutation_receipts_request_hash_idx
  ON wlt_mutation_receipts(request_hash);
