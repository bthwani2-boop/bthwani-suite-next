-- WLT-101 / payouts-destinations: prevent a second worker from claiming the same ambiguous
...
DROP TRIGGER IF EXISTS wlt_single_reconciliation_claim_trigger ON wlt_payout_requests;
