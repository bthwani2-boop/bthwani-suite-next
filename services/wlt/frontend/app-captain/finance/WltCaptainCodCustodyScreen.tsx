...
import type { WltDshCodReference } from "../../shared/wlt-cod/wlt-cod.api";
import {
  CaptainCodCustodyActions,
} from "../../shared/wlt-cod/CaptainCodCustodyActions";
import { fetchDshCaptainOwnCodRecords } from "../../shared/wlt-cod/wlt-cod.api";
...
export type WltCaptainCodCustodyScreenProps = {
  readonly onBack?: () => void;
  readonly embedded?: boolean;
};

export function WltCaptainCodCustodyScreen({ onBack, embedded = false }: WltCaptainCodCustodyScreenProps) {
