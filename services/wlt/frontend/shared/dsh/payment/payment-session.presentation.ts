...
const COPY: Record<WltPaymentSessionStatus, WltPaymentSessionPresentation> = {
  ...
  cod_pending: { label: "الدفع عند الاستلام", description: "سيسجل التحصيل عبر مسار عهدة COD.", tone: "info" },
  cod_collected: { label: "تم استلام النقد", description: "سجل WLT التحصيل النقدي.", tone: "success" },
