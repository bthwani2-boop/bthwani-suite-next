...
export const dshServiceManifest = {
  ...
  stage: "DSH-001_RUNTIME_VERIFIED_DSH-002_RUNTIME_VERIFIED_DSH-003_RUNTIME_VERIFIED_DSH-004_RUNTIME_VERIFIED_DSH-005_RUNTIME_VERIFIED_DSH-006_SCREENS_IMPLEMENTED_DSH-007_SCREENS_IMPLEMENTED_DSH-008_RUNTIME_VERIFIED_DSH-009_RUNTIME_VERIFIED",
  closureState: "RUNTIME_VERIFIED",
  activationScope: "stores-topic-all-surfaces-home-discovery-topic-two-surfaces-catalog-topic-three-surfaces-cart-checkout-wlt-handoff",
  ...
  nextSlice: {
    id: "DSH-006",
    name: "DSH-006 Order Fulfillment & Partner Acceptance",
