...
describe("delivery exceptions and return custody", () => {
...
describe("support conversation and order rescue", () => {
  ...
  const migration = source("../database/migrations/dsh-001_canonical_baseline.sql");
...
describe("Awnak and SHEIN special requests", () => {
...
describe("field visits and readiness", () => {
