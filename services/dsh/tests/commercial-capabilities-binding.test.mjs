...
describe("coupons, delivery pricing, and loyalty policies", () => {
...
describe("subscriptions and commercial benefits", () => {
  const commercial = source("../frontend/shared/marketing/use-commercial-programs-controller.tsx");
...
describe("promotion funding boundary", () => {
  ...
  it("uses trusted-context-bound idempotent outbox handoff", () => {
...
describe("service areas, SLA, capacity, and delivery modes", () => {
  const server = source("../backend/internal/http/server.go");
...
describe("partner fleet connection lifecycle", () => {
