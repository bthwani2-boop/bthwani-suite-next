...
import { IdentityRuntimeHealthPanel } from "../dashboard";
import { hasServiceControlPanelPermission } from "../session";
import { PlatformDashboardScreen } from "./PlatformDashboardScreen";
import { SovereignLeadershipPanel } from "./SovereignLeadershipPanel";

type PlatformSection = "control" | "identity-health" | "leadership";

export function PlatformWorkspaceScreen() {
      ...
      <div style={{ padding: "16px 16px 0" }}>
        <CpTabs
          ...
          items={[
            ...
            ...(canReadHealth
              ? [{ value: "identity-health" as const, label: "الخدمات والجاهزية — Identity" }]
              : []),
            ...(leadershipVisible
              ? [{ value: "leadership" as const, label: "القيادة والكادر السيادي" }]
              : []),
          ]}
        />
      </div>
