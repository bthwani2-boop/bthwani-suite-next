    ...
    <View style={styles.root}>
      ...
      <View style={styles.composer}>
        ...
        <Button
          ...
          leading={mutationState === "sending" ? <ActivityIndicator color={colorRoles.textInverse} /> : <Icon name="send" size={18} color={colorRoles.textInverse} />}
...
const styles = StyleSheet.create({
  ...
  headerButton: { width: 36, height: 36, borderRadius: 18, alignItems: "center", justifyContent: "center", backgroundColor: alpha(colorRoles.shadowBase, 0.04) },
  banner: { flexDirection: "row-reverse", alignItems: "center", gap: 6, paddingHorizontal: spacing[3], paddingVertical: 7, backgroundColor: alpha(colorRoles.brandAction, 0.08) },
  ...
  lightText: { color: colorRoles.textInverse },
  lightMutedText: { color: alpha(colorRoles.textInverse, 0.75) },
