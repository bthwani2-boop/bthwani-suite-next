  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {readinessState.kind === "success" && (
        <View style={[styles.readinessBanner, { borderColor: readinessState.vm.canActivate ? "#bbf7d0" : "#fecaca" }]}>
          <Text style={{ fontWeight: "700", color: readinessState.vm.canActivate ? "#15803d" : "#dc2626" }}>
            {readinessState.vm.canActivate ? "✓ ملفك مكتمل وجاهز" : "ملفك يحتاج استكمالاً"}
          </Text>
