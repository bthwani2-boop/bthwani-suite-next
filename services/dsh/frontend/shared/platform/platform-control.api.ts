...
type RejectPlatformChangeSetInput = components["schemas"]["ReviewReasonInput"];
type RollbackPlatformChangeSetInput = components["schemas"]["RollbackPlatformChangeSetInput"];
