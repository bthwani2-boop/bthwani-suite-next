...
const dshCaptainRoutes = [
  ...
  { routeId: 'dsh-captain-account-finance',  legacyRoute: 'account-finance',  screenId: 'captain.dsh.account.finance',      ownerPath: 'dsh/frontend/app-captain/account/DshCaptainFinanceScreen.tsx' },
