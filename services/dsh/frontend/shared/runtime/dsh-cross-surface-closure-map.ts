...
export const DSH_CROSS_SURFACE_CLOSURE_MAP: readonly DshCrossSurfaceClosureItem[] = [
  ...
  },
  {
    ...
    routeProof: 'SupportHubScreens.tsx يفسر workspace=customer-360 عبر query context ويفتح Customer360Workspace داخل /support.',
  ...
  },
  {
    ...
    routeProof: 'SupportHubScreens.tsx يفسر workspace=call-intake من query ويمرر customer/order/ticket/call context إلى ManualCallIntakeWorkspace.',
