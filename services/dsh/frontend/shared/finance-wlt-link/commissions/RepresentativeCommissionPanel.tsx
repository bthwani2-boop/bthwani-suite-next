...
type CommissionPanelState =
  ...
  | { readonly kind: "ready"; readonly commissions: readonly Commission[] };
...
function sourceLabel(commission: Commission): string {
...
export function RepresentativeCommissionPanel({
  ...
  const load = React.useCallback(async () => {
    ...
    try {
      const commissions = await fetchOwnCommissions(actorType);
