-- dsh-906_client_address_geofence_binding.sql
-- Enforces address-topology at the database boundary: every active client address must
...
COMMENT ON FUNCTION dsh_enforce_client_address_service_area() IS
    'address-topology: rejects active client-address writes that bypass governed DSH geofences.';
