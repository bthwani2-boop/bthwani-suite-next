-- DSH-099 / domain-007 S8: a client-home impression is counted once per
...
COMMENT ON INDEX uq_dsh_home_marketing_impression_view IS
  'Prevents duplicate domain-007 impressions for one banner/promo in one client view session.';
