-- order-truth / FS-18: strengthen business order numbers and make the WLT
...
CREATE OR REPLACE FUNCTION dsh_schedule_payment_projection()
...
DROP TRIGGER IF EXISTS trg_dsh_schedule_payment_projection ON dsh_orders;
CREATE TRIGGER trg_dsh_schedule_payment_projection
AFTER INSERT ON dsh_orders
FOR EACH ROW EXECUTE FUNCTION dsh_schedule_payment_projection();
