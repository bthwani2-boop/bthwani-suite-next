...
-- DSH-1032: preserve the canonical store-publication readiness contract while
-- keeping media optional. DSH-1031 made store media nullable and removed media
-- from publication prerequisites; this forward migration restores the
-- publication_decision/blocking_reason_codes contract consumed by the backend
-- without reintroducing machine-local media as a publication gate.
