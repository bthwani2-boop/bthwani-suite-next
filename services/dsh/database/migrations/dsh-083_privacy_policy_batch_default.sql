-- dsh-083_privacy_policy_batch_default.sql
-- A worker limit of zero means "use the governed policy batch_limit". Positive
-- values remain explicit bounded overrides for controlled maintenance runs.
