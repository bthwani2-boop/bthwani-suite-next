...
BEGIN
    ...
    INSERT INTO dsh_checkout_intents (
        ...
        checkout_id, 'OperatorContext-jrn-010-test', 'client-jrn-010-test', gen_random_uuid(),
    ...
    INSERT INTO dsh_checkout_wlt_event_receipts (
        ...
        'evt-jrn-010-0000000000000001', 'OperatorContext-jrn-010-test', checkout_id,
    ...
    BEGIN
        INSERT INTO dsh_checkout_wlt_event_receipts (
            ...
            'evt-jrn-010-0000000000000002', 'another-OperatorContext', checkout_id,
    ...
    BEGIN
        INSERT INTO dsh_checkout_wlt_event_receipts (
            ...
            'evt-jrn-010-0000000000000003', 'OperatorContext-jrn-010-test', checkout_id,
