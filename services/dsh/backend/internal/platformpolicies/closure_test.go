...
func TestOperationalDecisionAllowsCanonicalBthwaniFlow(t *testing.T) {
...
func TestOperationalDecisionFailsClosedForPause(t *testing.T) {
...
func TestOperationalDecisionFailsClosedForDisabledMode(t *testing.T) {
	snapshot := baseJRN029Snapshot()
...
func TestOperationalDecisionThrottlesAtConfiguredPressure(t *testing.T) {
	snapshot := baseJRN029Snapshot()
...
func TestClientPickupNeverCreatesCaptainDispatch(t *testing.T) {
	snapshot := baseJRN029Snapshot()
...
func TestOperationalDecisionRejectsServiceAreaMismatch(t *testing.T) {
	snapshot := baseJRN029Snapshot()
