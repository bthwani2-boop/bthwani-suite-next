...
// checkout and pickup paths to the canonical operational-policy fulfillment vocabulary.
...
// zone and live non-terminal order pressure before invoking the single operational-policy
