...
func TestJourneys026To030ExposeGovernedRoutes(t *testing.T) {
	...
	cases := []struct {
		...
		{journey: " list partner team", method: http.MethodGet, path: "/dsh/partner/stores/store-1/team", pattern: "GET /dsh/partner/stores/{storeId}/team"},
		{journey: " invite partner team member", method: http.MethodPost, path: "/dsh/partner/stores/store-1/team/invites", pattern: "POST /dsh/partner/stores/{storeId}/team/invites"},
		{journey: " act on partner team member", method: http.MethodPost, path: "/dsh/partner/stores/store-1/team/members/member-1/action", pattern: "POST /dsh/partner/stores/{storeId}/team/members/{memberId}/action"},
