...
func NewRouter(db *sql.DB, identityClient *auth.Client, wltClient *wlt.Client, mediaProvider *media.Provider, respCache *cache.Client) *http.ServeMux {
	...
	mux.HandleFunc("GET /dsh/control-panel/finance/references/payment-status", protected.handleFinanceReferencesPaymentStatus)
	mux.HandleFunc("GET /dsh/control-panel/finance/references/settlement-status", protected.handleFinanceReferencesSettlementStatus)
