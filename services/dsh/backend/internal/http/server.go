...
func NewRouter(db *sql.DB, identityClient *auth.Client, wltClient *wlt.Client, mediaProvider *media.Provider, respCache *cache.Client) *http.ServeMux {
	...
	mux.HandleFunc("PUT /dsh/operator/dispatch/captains/{captainId}/profile", protected.handleUpsertCaptainDispatchProfile)
	mux.HandleFunc("GET /dsh/operator/dispatch/candidates", protected.handleListCaptainDispatchCandidates)
	mux.HandleFunc("POST /dsh/operator/dispatch/assignments/{assignmentId}/reassign", protected.handleReassignGovernedDispatchAssignment)
	mux.HandleFunc("POST /dsh/operator/dispatch/assignments/{assignmentId}/cancel", protected.handleCancelGovernedDispatchAssignment)
	mux.HandleFunc("POST /dsh/operator/dispatch/assignments/expire", protected.handleExpireGovernedDispatchAssignments)
	mux.HandleFunc("GET /dsh/operator/dispatch/decisions", protected.handleListDispatchDecisions)
	...
	mux.HandleFunc("POST /dsh/control-panel/finance/payment-sessions/{paymentSessionId}/refresh-provider-status", protected.handleRefreshFinancePaymentSessionProviderStatus)
	...
	mux.HandleFunc("GET /dsh/control-panel/finance/cod-reconciliation-cases", protected.handleFinanceCodReconciliationCases)
	mux.HandleFunc("POST /dsh/control-panel/finance/cod-reconciliation-cases/{caseId}/assign", protected.handleAssignFinanceCodReconciliationCase)
	mux.HandleFunc("POST /dsh/control-panel/finance/cod-reconciliation-cases/{caseId}/resolve", protected.handleResolveFinanceCodReconciliationCase)
