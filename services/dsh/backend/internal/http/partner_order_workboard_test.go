...
func TestPartnerOrderAllowedActions(t *testing.T) {
	tests := []struct {
		...
		{name: "accepted with resolvable issue", status: "store_accepted", mode: "bthwani_delivery", openIssueCount: 1, resolvableIssueCount: 1, want: []string{"prepare", "revise_estimate", "report_issue", "resolve_issue"}},
		{name: "accepted waiting customer substitution decision", status: "store_accepted", mode: "bthwani_delivery", openIssueCount: 1, want: []string{"prepare", "revise_estimate", "report_issue"}},
		{name: "preparing ready", status: "preparing", mode: "bthwani_delivery", want: []string{"ready", "revise_estimate", "report_issue"}},
		{name: "preparing resolvable issue blocks ready", status: "preparing", mode: "bthwani_delivery", openIssueCount: 2, resolvableIssueCount: 1, want: []string{"revise_estimate", "report_issue", "resolve_issue"}},
		{name: "preparing pending substitution blocks ready and resolve", status: "preparing", mode: "bthwani_delivery", openIssueCount: 1, want: []string{"revise_estimate", "report_issue"}},
		...
		{name: "handoff exception blocks confirmation", status: "driver_arrived_store", mode: "bthwani_delivery", handoffStatus: "awaiting_partner", handoffException: true, want: []string{}},
