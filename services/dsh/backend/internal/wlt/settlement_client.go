...
// FinanceWriteSettlement calls only the two governed WLT settlement mutation
// shapes: order-source creation and partner policy upsert. It is intentionally
// separate from the generic payout/reconciliation allowlist.
