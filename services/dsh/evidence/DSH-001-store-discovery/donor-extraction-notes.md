...
| `dsh/frontend/shared/stores/stores.view-model.ts` | ViewModel separation from DTO | `services/dsh/frontend/shared/store-discovery/store-discovery.view-model.ts` | DTO Ã¢â€ â€™ ViewModel mapping prevents leaking API shape to UI |
