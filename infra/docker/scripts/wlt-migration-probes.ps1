...
$script:WltMigrationProbes = [ordered]@{
  ...
  "wlt-093_mutation_receipts.sql" = "to_regclass('public.wlt_mutation_receipts') IS NOT NULL AND (to_regclass('public.wlt_mutation_receipts_aggregate_idx') IS NOT NULL OR to_regclass('public.wlt_mutation_receipts_tenant_aggregate_idx') IS NOT NULL) AND (to_regclass('public.wlt_mutation_receipts_request_hash_idx') IS NOT NULL OR to_regclass('public.wlt_mutation_receipts_tenant_request_hash_idx') IS NOT NULL)"
  ...
  "wlt-098_payout_destination_governance.sql" = "to_regclass('public.wlt_payout_audit_events') IS NOT NULL AND to_regclass('public.wlt_payout_outbox') IS NOT NULL AND to_regclass('public.wlt_payout_reconciliations') IS NOT NULL"
  ...
  "wlt-105_financial_tenant_context_and_ledger.sql" = "EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'wlt_ledger_accounts' AND column_name = 'tenant_id' AND is_nullable = 'NO') AND to_regclass('public.wlt_ledger_transactions_source_tenant_uq') IS NOT NULL AND to_regclass('public.wlt_field_commission_category_policy_active_tenant_uq') IS NOT NULL AND to_regclass('public.wlt_commission_evidence_tenant_idempotency_uq') IS NOT NULL AND to_regclass('public.wlt_mutation_receipts_tenant_aggregate_idx') IS NOT NULL"
  "wlt-106_settlement_tenancy.sql" = "EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'wlt_settlement_policies' AND column_name = 'tenant_id' AND is_nullable = 'NO') AND to_regclass('public.wlt_settlement_policy_tenant_current_idx') IS NOT NULL AND to_regclass('public.wlt_settlement_completion_event_tenant_uidx') IS NOT NULL AND to_regclass('public.wlt_settlement_request_tenant_hash_uidx') IS NOT NULL"
  "wlt-107_commission_tenancy.sql" = "EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'wlt_commission_policy_versions' AND column_name = 'tenant_id' AND is_nullable = 'NO') AND to_regclass('public.wlt_commission_policy_active_tenant_uidx') IS NOT NULL AND to_regclass('public.wlt_commissions_tenant_idempotency_idx') IS NOT NULL AND to_regclass('public.wlt_commission_adjustments_tenant_idempotency_uq') IS NOT NULL"
  ...
  "wlt-109_cod_custody_tenancy.sql" = "to_regclass('public.wlt_cod_records_tenant_order_uq') IS NOT NULL AND EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='wlt_cod_custody_evidence' AND column_name='tenant_id' AND is_nullable='NO') AND to_regclass('public.wlt_cod_custody_evidence_tenant_record_created_idx') IS NOT NULL AND to_regclass('public.wlt_cod_reconciliation_tenant_status_created_idx') IS NOT NULL AND to_regclass('public.wlt_cod_reconciliation_audit_tenant_case_created_idx') IS NOT NULL"
  "wlt-110_payment_reconciliation_tenancy.sql" = "EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='wlt_reconciliation_cases' AND column_name='tenant_id' AND is_nullable='NO') AND to_regclass('public.wlt_reconciliation_cases_tenant_session_idx') IS NOT NULL AND to_regclass('public.wlt_reconciliation_cases_tenant_status_idx') IS NOT NULL AND to_regclass('public.wlt_reconciliation_cases_tenant_open_uq') IS NOT NULL"
