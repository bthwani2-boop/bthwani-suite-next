...
$script:WltMigrationProbes = [ordered]@{
  ...
  "wlt-093_jrn036_mutation_receipts.sql" = "to_regclass('public.wlt_jrn036_mutation_receipts') IS NOT NULL AND (to_regclass('public.wlt_jrn036_mutation_receipts_aggregate_idx') IS NOT NULL OR to_regclass('public.wlt_jrn036_mutation_receipts_tenant_aggregate_idx') IS NOT NULL) AND (to_regclass('public.wlt_jrn036_mutation_receipts_request_hash_idx') IS NOT NULL OR to_regclass('public.wlt_jrn036_mutation_receipts_tenant_request_hash_idx') IS NOT NULL)"
