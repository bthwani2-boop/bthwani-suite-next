...
$script:WltMigrationProbes = [ordered]@{
  ...
  "wlt-090_jrn036_settlement_commission_governance.sql" = "(to_regclass('public.wlt_jrn036_settlement_requests') IS NOT NULL OR to_regclass('public.wlt_settlement_requests') IS NOT NULL) AND (to_regclass('public.wlt_jrn036_commission_policy_versions') IS NOT NULL OR to_regclass('public.wlt_commission_policy_versions') IS NOT NULL) AND (to_regclass('public.wlt_jrn036_audit_events') IS NOT NULL OR to_regclass('public.wlt_finance_audit_events') IS NOT NULL)"
  "wlt-091_jrn036_adjustment_ledger_identity.sql" = "to_regclass('public.wlt_jrn036_commission_adjustments_request_hash_idx') IS NOT NULL OR to_regclass('public.wlt_jrn036_commission_adjustments_tenant_request_hash_idx') IS NOT NULL"
  ...
  "wlt-093_jrn036_mutation_receipts.sql" = "(to_regclass('public.wlt_jrn036_mutation_receipts') IS NOT NULL OR to_regclass('public.wlt_mutation_receipts') IS NOT NULL) AND (to_regclass('public.wlt_jrn036_mutation_receipts_aggregate_idx') IS NOT NULL OR to_regclass('public.wlt_jrn036_mutation_receipts_tenant_aggregate_idx') IS NOT NULL) AND (to_regclass('public.wlt_jrn036_mutation_receipts_request_hash_idx') IS NOT NULL OR to_regclass('public.wlt_jrn036_mutation_receipts_tenant_request_hash_idx') IS NOT NULL)"
  ...
  "wlt-098_jrn037_payout_destination_governance.sql" = "(to_regclass('public.wlt_jrn037_payout_audit_events') IS NOT NULL OR to_regclass('public.wlt_payout_audit_events') IS NOT NULL) AND (to_regclass('public.wlt_jrn037_payout_outbox') IS NOT NULL OR to_regclass('public.wlt_payout_outbox') IS NOT NULL) AND (to_regclass('public.wlt_jrn037_payout_reconciliations') IS NOT NULL OR to_regclass('public.wlt_payout_reconciliations') IS NOT NULL)"
