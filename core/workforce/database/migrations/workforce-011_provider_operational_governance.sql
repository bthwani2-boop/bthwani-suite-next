-- Workforce-011: converge provider operational governance after the original
-- workforce-005 operational-enforcement migration. This unique ledger entry
-- replaces the duplicate workforce-005 filename that previously created
-- ordering and checksum ambiguity.
--
-- WLT remains the source of monetary truth. Workforce stores only immutable
-- references needed to prove that operational gates were reviewed.
