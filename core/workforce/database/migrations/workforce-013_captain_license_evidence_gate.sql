-- Workforce-013: enforce captain licence evidence with a unique migration ID.
-- This replaces the legacy duplicate workforce-004 filename. The statements
-- remain idempotent so databases that previously applied the old file converge.
BEGIN;
