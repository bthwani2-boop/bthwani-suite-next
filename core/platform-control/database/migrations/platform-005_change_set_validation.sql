-- PLATFORM-005: immutable validation snapshots for governed change sets.
...
COMMENT ON COLUMN platform_change_set_items.validated_value_json IS
    'Full target-state snapshot captured atomically during change-set validation; compared again before submit, approval, and apply.';
