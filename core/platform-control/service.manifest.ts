export const platformControlServiceManifest = {
  ...
  boundaries: {
    owns: [
      ...
      "platform_rollout_resume_contract",
      "platform_rollout_health_alert_contract",
      "platform_rollout_recovery_contract",
    ...
    allowedForDshControlPanel: [
      ...
      "platform_rollout_recovery_read_when_authorized",
  ...
  closure: {
    ...
    requiredBeforeRelease: [
      ...
      "cross_operator_context_isolation_evidence",
      "visual_evidence",
