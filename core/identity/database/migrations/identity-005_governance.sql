--  FS-05: database invariants, concurrency indexes, and retention support.
...
COMMENT ON TABLE identity_sessions IS
  'Sovereign  access/refresh sessions; refresh tokens rotate and revoked sessions never reactivate.';
