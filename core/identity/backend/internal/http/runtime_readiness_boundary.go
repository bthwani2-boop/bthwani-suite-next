...
const (
	...
	identityLatestMigration           = "identity-017_employee_dsh_permission_integrity.sql"
...
func configurationChecks() runtimeReadinessResult {
	...
	configuration := []struct {
		...
		{"operator_context", strings.TrimSpace(os.Getenv("BTHWANI_OPERATOR_CONTEXT_ID")) != "", reasonConfigurationInvalid},
