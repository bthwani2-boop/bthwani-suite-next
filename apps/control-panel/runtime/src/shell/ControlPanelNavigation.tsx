  ...
  return (
    <nav dir={dir} style={styles.nav} aria-label="قائمة لوحة التحكم">
      ...
      <div
        style={{
          ...styles.versionBadge,
          borderTop: footer == null ? "1px solid var(--cp-sidebar-border)" : undefined,
        }}
      >
...
const styles = WebStyleSheet.create({
  ...
  navItemButton: {
    ...
    fontSize: "0.9rem",
    transition: "all 0.18s var(--cp-ease-smooth, ease)",
    position: "relative",
  },
  activeIndicator: {
    position: "absolute",
