...
head_sha: `bb6c661e49cdde3fd44e5598889790ea6f4ba7c0`
...
| `jaeger` | optional | `NO_COMMAND_DECLARED` | OPTIONAL, NEEDS_OWNER |
| `jscpd` | optional | `NO_COMMAND_DECLARED` | OPTIONAL, NEEDS_OWNER |
| `k6` | optional | `NO_COMMAND_DECLARED` | OPTIONAL, NEEDS_OWNER |
...
- `guard:journey:full`: UNUSED_SCRIPT
...
- `diagnostics:ui-kit-catalog`: UNUSED_SCRIPT
